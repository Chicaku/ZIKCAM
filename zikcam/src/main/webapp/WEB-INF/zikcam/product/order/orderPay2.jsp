...
<body> 
	...
	<input type="hidden" id="PROD_NUM" name="PROD_NUM" value="${map.prod_num}"/>
	...
	<input type="hidden" id="ORDER_DPRICE" name="ORDER_DPRICE" value="2500"/>  
	...
	<input type="hidden" id="PROD_COUNT" name="PROD_COUNT" value="${map.countNum}"/>
	<input type="hidden" id="ORDER_STATUS" name="ORDER_STATUS" value="상품 준비중"/>
            ...
            if ( rsp.success ) {
                ...
                $.ajax({
			    	...
			    	data:{
				    		...
				    		PROD_NUM:$("input[name='PROD_NUM']").val(),
				    		ORDER_STATUS:$("input[name='ORDER_STATUS']").val()
			    		}, 
                ...
                //실패시 이동할 페이지
                location.href="../prod/orderPayFail2";
                alert(msg);
            }
        });
