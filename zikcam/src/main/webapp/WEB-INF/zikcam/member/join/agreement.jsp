...
<head>
<meta charset="UTF-8">
<link rel="stylesheet"  href="<c:url value='/resources/css/agreement.css'/>" >
</head>
<body>
<header>
			<div class="logo-wrap">
...
<form action="/zikcam/member/join" id="joinForm">
            <ul class="join_box">
                ...
                <li class="checkBox check02">
                    ...
                    <textarea name="" id="">ZIKCAM 전자상거래(인터넷사이버몰) 이용약관
...
제1조(목적) 이 약관은 ZIKCAM회사(전자상거래 사업자)가 운영하는 ZIKCAM사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
 
  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
 
제2조(정의)
 
①	 “몰”이란 ZIKCAM회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
네이버 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 네이버 서비스의 이용과 관련하여 네이버 서비스를 제공하는 네이버 주식회사(이하 ‘네이버’)와 이를 이용하는 네이버 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 네이버 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
        ...
        <button 
			style="outline:0; border:0;  border-radius: 6px; width: 226px; height:60px; background-color:black; color:white;" 
			value="updatemem">돌아가기</button>
		<button 
			style="outline:0; border:0;  border-radius: 6px; width: 226px; height:60px; background-color:black; color:white;" 
			value="updatemem">계속하기</button>
        </form>
       
        <!-- Footer-->
       <footer class="py-5 bg-light" style="background-color:#808080; position:absolute; top:120%; left: 50%; transform:translate(-50%, -50%);">
