			...
			<table style="width: 100%; border:0.5px solid white;">
                <%-- <c:if test="${session_MEM_ID == null }"> --%>	
               	...
               	<c:if test="${session_MEM_ID != null }">
               		<td style="background-color:gray; color:black;">
               			<button class="btn-outline-dark" style="outline:0; border:0; width:100%; height:78px;
               			 text-align:left;" name="rental2" value="rental" onclick="location.href='../prod/rentalDate'">대여
               			</button>
               		</td>
               	</c:if>
               	  
               	<c:if test="${purchaseCategory == '텐트/타프' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark active" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="tent" onClick="location.href='/zikcam/prod/purchaseTent'"> 텐트 / 타프
               			</button>
               		</td>
               	</c:if>
               	<c:if test="${purchaseCategory != '텐트/타프' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="tent" onClick="location.href='/zikcam/prod/purchaseTent'"> 텐트 / 타프
               			</button> 
               		</td>
               	</c:if>  
               	<c:if test="${purchaseCategory == '매트/침낭' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark active" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="mat" onClick="location.href='/zikcam/prod/purchaseMatt'"> 매트 / 침낭
               			</button>
               		</td>
               	</c:if>
               	<c:if test="${purchaseCategory != '매트/침낭' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="mat" onClick="location.href='/zikcam/prod/purchaseMatt'"> 매트 / 침낭
               			</button> 
               		</td>
               	</c:if> 
                <c:if test="${purchaseCategory == '테이블/체어' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark active" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="table" onClick="location.href='/zikcam/prod/purchaseTable'"> 테이블 / 체어
               			</button>
               		</td>
               	</c:if>
               	<c:if test="${purchaseCategory != '테이블/체어' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="table" onClick="location.href='/zikcam/prod/purchaseTable'"> 테이블 / 체어
               			</button> 
               		</td>
               	</c:if> 
                <c:if test="${purchaseCategory == '기타' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark active" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="etc" onClick="location.href='/zikcam/prod/purchaseEtc'"> 기타
               			</button>
               		</td>
               	</c:if>
               	<c:if test="${purchaseCategory != '기타' }">
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button class="btn-outline-dark" style="outline:0; border:0; width:100%; height:78px;" name="sortType3" value="etc" onClick="location.href='/zikcam/prod/purchaseEtc'"> 기타
               			</button> 
               		</td>
               	</c:if> 
				</tr>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		/* $("#puchase2").on("click", function(e){ //렌탈 날짜선택 페이지
			e.preventDefault();
			if("${start_date || end_date}"){
				fn_openRentalList();
			}else {
		...
		$("button[name=listType]").on('click', function(){
			
			var listType = $(this).val();
			
			if(listType == 'purchase') {
				$('button[value=purchase]').addClass('active');
				$('button[value=rental]').removeClass('active');
			} else if(listType == 'rental') {
				$('button[value=rental]').addClass('active');
				$('button[value=purchase]').removeClass('active');
			} 
