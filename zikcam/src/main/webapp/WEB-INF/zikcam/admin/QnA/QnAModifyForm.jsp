...
<body>
					...
					<form id="modifyForm">
						...
						<table>
							<tr>
								...
								<td colspan="3">
									<input style="width:100%;" type="text" id="TITLE" name="TITLE" value="${map.QNA_TITLE }"/>
								</td>
							</tr>
							<tr>
						...
						<tr style="min-height:100px;">
							<td colspan="4">
								<textarea style=" width:100%;" id="CONTENT" name="CONTENT" rows="20" cols="100" title="${map.QNA_CONTENT }">${map.QNA_CONTENT }</textarea>
	...
	<script type="text/javascript">
		...
		function fn_modifyQnA(){
				...
				comSubmit.setUrl("<c:url value='/admin/QnAModify' />");
				comSubmit.submit();
		}
