							...
							<table>
								<tr>
									<td colspan="1" align="center"
										style="background-color: #E6E6E6;">제목</td>
								...
								<tr>
									<td colspan="4" align="center"
										style="background-color: #E6E6E6;">내용</td>
								</tr>
								<tr style="min-height: 100px;">
									<td colspan="4">
							...
							<table>
								<tr>
									...
									<td colspan="3"><input style="width: 100%;" type="text"
										id="TITLE" name="TITLE" value="답변입니다." /></td>
								</tr>
								<tr>
									<td colspan="4" align="center"
										style="background-color: #E6E6E6;">내용</td>
								...
								<tr style="min-height: 100px;">
									<td colspan="4"><textarea style="width: 100%;"
											id="CONTENT" name="CONTENT" rows="20" cols="100" title="내용"></textarea>
									</td>
								</tr>
							</table>
	...
	<script type="text/javascript">
		...
		function fn_deletePQ(){
			...
			if($("#PNUM").val()){
				...
				//삭제로직은 글번호의 값이 0이 아닌 경우를 판단해서 작동하므로 DB의 시퀀스 시작값이 1이어야하고 글번호 0번이 존재하지 않아야함
