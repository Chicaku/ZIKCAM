...
public interface MyReviewService {
	...
	List<Map<String, Object>> selectReviewList(Map<String, Object> commandMap, String keyword, String searchType, String sortType, String formSortType) throws Exception;
