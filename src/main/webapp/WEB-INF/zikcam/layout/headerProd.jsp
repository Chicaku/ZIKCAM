            ...
            <table style="width: 100%; border:0.5px solid white;">
               	<tr height="78px" >
               		<td style="width: 11%; background-color:black; color:white;">
               			<button style="outline:0; border:0; width:100%; height:78px; background-color:black; color:white;
               			 text-align:right;" onClick="location.href='/zikcam/prod/purchaseTent'">구매
               			</button >
               		</td>
               		<td style="width:2%; height:78px; background-color:black; color:white; text-align:center;">/</td>
               		<td style="width: 11%; background-color:black; color:white;">
               			<button style="outline:0; border:0; width:100%; height:78px; background-color:black; color:white;
               			 text-align:left;" onClick="location.href='/zikcam/prod/rentalDate'">대여
               			</button>
               		</td>
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button style="outline:0; border:0; width:100%; height:78px;" onClick="location.href='/zikcam/prod/purchaseTent'"> 텐트 / 타프
               			</button>
               		</td>
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button style="outline:0; border:0; width:100%; height:78px;" onClick="location.href='/zikcam/prod/purchaseMatt'"> 침낭 / 매트
               			</button>
               		</td>
               		<td align="center" style="width: 19%; background-color:gray; color:black;">
               			<button style="outline:0; border:0; width:100%; height:78px;" onClick="location.href='/zikcam/prod/purchaseTable'"> 테이블 / 체어
               			</button>
               		</td>
                   	<td align="center" style="width: 19%; background-color:gray; color:black;">
                   		<button style="outline:0; border:0; width:100%; height:78px;" onClick="location.href='/zikcam/prod/purchaseEtc'"> 기타
                   		</button>
                   	</td>
				</tr>
			</table>
