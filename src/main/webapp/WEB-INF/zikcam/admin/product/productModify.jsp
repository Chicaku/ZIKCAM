	...
	<main>
				<section class="py-5">
					<div class="container px-4 px-lg-5 mt-5">
						<input id="prod_num" type="hidden" value="${map.PROD_NUM}">
						...
						<table class="table">
							<tr>
								...
								<td width="80%">
									<input id="prod_name" type="text" style="width:50%" value="${map.PROD_NAME}">
								</td>
							</tr>
							<tr>
								<td align="right"><font color="red" size="3">* </font>카테고리</td>
								<td>
									<input type="hidden" id="prod_category" value="${map.PROD_CATEGORY}">
							...
							<tr>
								...
								<td><input id="prod_price" type="text" style="width:50%" value="${map.PROD_PRICE}"></td>
							</tr>
							<tr>
								<td align="right">구매 수량</td>
								<td><input id="prod_stock" type="text" style="width:50%" value="${map.PROD_STOCK}"></td>
							</tr>
							<tr>
								<td align="right">대여 가격</td>
								<td><input id="prod_rprice" type="text" style="width:50%" value="${map.PROD_RPRICE}"></td>
							</tr>
							<tr>
								<td align="right">대여 수량</td>
								<td><input id="prod_rstock" type="text" style="width:50%" value="${map.PROD_RSTOCK}"></td>
							</tr>
						</table>
						<br/><br/>
...
<script type="text/javascript">
	    $(document).ready(function(){
	    	...
	    	$("button[name='updatebt']").on("click", function(e) {
	            var index = $("button[name='updatebt']").index(this);
	            e.preventDefault();
	    	...
	    	/* $('button#updatebt').on('click', function() {
	    		...
	    		// 상품 테이블 수정
	        	 $.ajax({
	        		type: "POST",
	        		url:"<c:url value='/admin/productUpdate'/>",
	    ...
	    function fn_openProductModify(index) {
	         ...
	         comSubmit.addParam("num", $('span#prod_num').eq(index).text()); 
	         comSubmit.submit();
	      }
