					...
					<div class="container px-4 px-lg-5 mt-5">
						...
						<table class="table">
							...
							<tr>
								...
								<td colspan="4"><textarea style="width:100%;" rows="15" title="메인 이미지" id="PROD_THUMB" name="PROD_THUMB"></textarea></td>
							</tr>
							<tr bgcolor="gray" align="center">
								<th scope="row" colspan="4">서브 이미지(다중) </th>
							</tr> 
							<tr>
								<td colspan="4"><textarea style="width:100%;" rows="15" title="서브 이미지" id="PROD_SUB" name="PROD_SUB"></textarea></td>
							</tr>
							<tr bgcolor="gray" align="center">
