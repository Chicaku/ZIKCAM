        ...
        <header class="bg-dark py-5" style="background-image : url('images/CampGrounds_California_5.jpg'); object-fit: contain">
            ...
            <div class="container px-4 px-lg-5 my-5">
                ...
                <!-- <image src="images/CampGround.jpg" style='/* height: 100%; width: 100%;  */object-fit: contain'> -->
                	<h1 class="display-4 fw-bolder">기타 용품 구매</h1>
                </div>
            </div>
        </header>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="../prod/productDetail?PROD_NUM=8">상세보기 </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
